# Comentario: configuración por defecto, constantes y avisos
...
# Ruta a tu configs.ini (ajústala si cambia)
...
__all__ = [
    "CONFIG_PATH", "WARN", "NOTE", "EPS32", "EPS64",
    "gdefaults", "_get_gdefaults", "process_value", "process_special",
]
