#%%#
import numpy as np
from SSQ_Chatter import sqq_chatter, five_senos, signal_1
from matplotlib import pyplot as plt

from typing import Sequence, Tuple, Dict, Optional, Callable, Mapping, List, Any, Union


from SSQ_Chatter_C import ChatterPipeline, PipelineConfig
from SSQ_Chatter_C import SSQ_STFT, STFT
from SSQ_Chatter_C import ThreeSigmaWithLilliefors
# from SSQ_Chatter_C import five_senos  # reexportado desde compat/legacy
...
fs = 10240.0
t, x = five_senos(fs=fs, duracion=2.0, ruido_std=4.0, fase_aleatoria=False, seed=120)
...
dir_path_use = data_path_1DOF_150Hz_20mm_7_5k_12kSpdS_100_F_0_05_L_50mm_Statico_Green
