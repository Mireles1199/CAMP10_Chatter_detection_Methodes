# Comentario: utilidades FFT (puras) y clase FFT con pyFFTW opcional
from __future__ import annotations
from typing import Any
import numpy as np

# Si usas pyFFTW y scipy.fft, copia también sus imports como en tu archivo
...
from .misc import IS_PARALLEL  # usado por FFT.threads
from numba import jit           # para _xifn

__all__ = [
    "FFT", "FFT_GLOBAL", "fft", "rfft", "ifft", "irfft",
    "fftshift", "ifftshift", "_xifn",
]
